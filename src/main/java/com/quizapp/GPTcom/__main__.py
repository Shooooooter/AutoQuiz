...
def generate_quiz(num_questions, quiz_type, topic, difficulty):
    ...
    response = openai.Completion.create(
        ...
        prompt=f"Generate a quiz with {num_questions} {quiz_type} questions on the topic of {topic} of {difficulty} also generate the id randomly too"+ '''difficulty with Answers,i will store it in a json, here is an example as to how to fromat the generated questions. 
        [
          {
            "id": 1,
