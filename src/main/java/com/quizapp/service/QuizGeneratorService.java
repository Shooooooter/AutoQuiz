...
public class QuizGeneratorService {
    ...
    private static final String PYTHON_SCRIPT_PATH = "/quiz_generator.py";
    ...
    public static Quiz generateQuiz(int noOfQuestions, QuizType quizType, Topic topic, QuizDifficulty quizDifficulty) throws IOException, InterruptedException {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            Question question = new Question(questionData[0], questionData[1], questionData[2], questionData[3]);
        ...
        return new Quiz(topic, quizDifficulty, quizType, questionList);
    }
}
